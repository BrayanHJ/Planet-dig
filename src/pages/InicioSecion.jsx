    ...
    return (
        <AnimatedPage>
            <main className="flex items-center justify-center
                ...
                <img src="src/assets/fiesta-fondo.jpg" alt="nothing"  className="fixed top-0 left-0 w-full h-full object-cover" />
                ...
                <AnimatePresence>
                    ...
                    >
                        <img src="../../public/Nova_Events.png" alt="Nova Events" className=" ml-5 mt-4  rounded-full h-20 w-20" />
                        <motion.h1 className="text-6xl text-white-outline font-bold text-violet-800  justify-center"
                    ...
                    >
                        ...
                        <form onSubmit={handleSubmit}>
                            <motion.label className="block text-2xl font-bold text-yellow-500/80"
